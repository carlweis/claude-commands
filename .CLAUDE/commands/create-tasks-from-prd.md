...
- **Frontend**: HTML5, Tailwind CSS, Vite + TypeScript + React
- **JavaScript**: Always use React + TypeScript
...
- Identify existing react and typescript usage patterns
...
- Include testing requirements for each change (RSpec/Capybara + Jest)
...
- `app/frontend` - Vite + TypeScript + React setup/code
- `app/frontend/entrypoints/` - frontend entrypoints
- `app/frontend/components/` - frontend components
- `app/frontend/components/shared` - shared frontend components
...
### Feature Tests
- `spec/features/[feature_name]_spec.rb` - Feature specific tests
### Request Tests
- `spec/requests/[endpoint]_spec.rb` - Request tests
### Frontend Jest Tests
- `app/frontend/test/[feature_name]_test.js` - Frontend jest tests
